...
const ROLE_COLORS: Record<string, string> = {
  ...
  CULTIVATOR: 'bg-green-500/20 text-green-400', LAB_TECH: 'bg-amber-500/20 text-amber-400',
  IRRIGATION_TECH: 'bg-blue-500/20 text-blue-400',
  SECURITY_OFFICER: 'bg-red-500/20 text-red-400', TRIMMER: 'bg-emerald-500/20 text-emerald-400',
