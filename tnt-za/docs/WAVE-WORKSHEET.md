...
| 7.4 | Audit-log every close / sign-off / reopen | ✅ SHIPPED | live: close+reopen → 2 hash-chained AuditLog rows. commit 422a8b1 |

## WAVE 8 — Forms real & timed
| # | Task | Status | Evidence |
|---|------|--------|----------|
| 8.1 | Load real cultivation forms as recurring TaskTemplates | ✅ SHIPPED | live: 19 real templates w/ real items + EU-GMP cites; 36 placeholders deactivated. commit e591635 |
...
| # | Task | Status | Evidence |
|---|------|--------|----------|
| 9.1 | Wire ComplianceControl — forms → cited EU-GMP evidence | ✅ SHIPPED | live: 19 controls, 24 links; 3 mortality NEEDS_SPECIALIST_SIGNOFF. commit 1a968a1 |
