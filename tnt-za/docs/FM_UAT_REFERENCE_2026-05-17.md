# TnT-ZA Facility Manager UAT Reference
...
This UAT document validates that the Facility Manager can run day-to-day site operations in TnT-ZA with all critical actions persisted to the database, audited, and connected to the EU GMP grounded QMS workflow.

The Facility Manager test is not only a dashboard review. It must prove that operational CTAs work end to end across assets, labels, batches, environmental checks, tickets, deviations, SOP-linked tasks, training, mortality, and audit evidence.
...
| `Create the right next action for an out-of-range humidity reading.` | Explains that the controlled path is ticket/deviation/escalation, not informal chat notes. | Tickets, QMS, Environment Log |
...
4. Ask: `What needs my attention as Facility Manager today?`
5. Click the returned `Tickets` action and show that the assistant routes into a real workflow.
6. Return to the assistant and ask: `Show me my EU GMP risks for facility operations.`
7. Click `QMS` or `SOP Library` and show that the answer is grounded in controlled workflows.
8. Ask: `Help me investigate a label accountability issue.`
9. Click the label/scan/asset action and explain that labels must include the asset/container name plus unique ID.
...
2. Ask: `What needs my attention as Facility Manager today?`
3. Ask: `Show me my EU GMP risks for facility operations.`
4. Ask: `Help me investigate a label accountability issue.`
5. Ask: `What evidence would an auditor ask me for on this issue?`
6. Click each returned context action.
...
- Every assistant CTA opens, is role-appropriate, and leads to a persisted operational workflow.
