...
test.describe('Retail Store Mobile Flow with EFT Approval', () => {
    ...
    test('Complete mobile flow: Order → EFT Payment → Supervisor Approval → Staff Queue', async () => {
        ...
        console.log('\n🧪 STEP 2: Browse Retail Store Products (Mobile)');
        ...
        // STEP 6: Place order
        console.log('\n🧪 STEP 6: Place Retail Store Order');
        ...
        await supervisorPage.fill('input[name="email"]', 'admin@basothomedicalherbs.ls');
        ...
        console.log('\n🧪 STEP 11: Load Retail Store Queue');
