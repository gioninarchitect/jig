 ...
 * Demonstrates multi-role collaboration for Drive-Through Module Specification
 */
...
async function createOpenSpecStructure() {
    ...
    const baseDir = path.join(__dirname, 'openspec/drive-through-module');
...
async function frontendPhase() {
    ...
    const components = [
        ...
        'OrderHistory - Past drive-through orders'
    ];
...
async function backendPhase() {
    ...
    await simulateWork('Backend Developer', 'Creating drive-through API endpoints', 900);
    ...
    const endpoints = [
        'POST /api/v1/drive-through/order - Create drive-through order',
        'GET /api/v1/drive-through/queue - Get current queue status',
        'POST /api/v1/drive-through/arrival - Notify arrival at pickup',
        'PUT /api/v1/drive-through/location - Update customer location',
        'GET /api/v1/drive-through/orders/:id - Get order status',
        'POST /api/v1/drive-through/complete - Complete order pickup'
    ];
...
async function finalReview() {
    ...
    console.log(`${colors.bright}Drive-Through Module Specification - APPROVED${colors.reset}
...
async function generateSpecificationFiles() {
    ...
    const mainSpec = `# Drive-Through Module - Technical Specification
...
`;
    ...
    const scenarios = `# Drive-Through Module - Test Scenarios
...
${colors.bright}╔════════════════════════════════════════════════════════════════════════════╗
║                         OPENSPEC WORKFLOW SIMULATION                       ║
║                    Drive-Through Module Specification                      ║
║                              CBD Wellness 24                               ║
╚════════════════════════════════════════════════════════════════════════════╝${colors.reset}
    `);
...
${colors.info}Generated Files:${colors.reset}
  📄 openspec/drive-through-module/project.md
  📄 openspec/drive-through-module/specs/main-spec.md
  📄 openspec/drive-through-module/specs/test-scenarios.md
