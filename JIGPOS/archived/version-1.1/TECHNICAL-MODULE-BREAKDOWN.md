# CBD Wellness 24 - Technical Module Breakdown
...
This is the **core CBD Wellness 24 system** that every merchant gets:
...
**What Needs White-Labeling:**
⚠️ **CBD Wellness 24 branding** in section21-info.html
- Email: section21@cbdwellness24.co.za → merchant email
...
{
  merchantId: ObjectId,
  businessName: String,           // "CBD Wellness 24" → "ABC Pharmacy"
  branding: {
  ...
  contact: {
    email: String,                // "hello@cbdwellness24.co.za" → merchant email
    phone: String,
    address: String
  },
  location: {
...
```
⚠️ index.html                    - Replace "CBD Wellness 24" with {{businessName}}
...
```javascript
// Current:
<title>CBD Wellness 24</title>
<h1>CBD Wellness 24</h1>
...
1. **Frontend Templating**
   - Replace hardcoded "CBD Wellness 24" with `{{businessName}}`
...
1. **Subdomain Strategy**
   - merchant1.cbdwellness24.co.za
   - merchant2.cbdwellness24.co.za
...
⚠️ Hardcoded "CBD Wellness 24" branding (~15 files)
