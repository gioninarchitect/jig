...
- [ ] MongoDB running: Check `cbdwellness24` database
...
**Subject:** "Welcome to CBD Wellness 24 - 20% Off Your First Order!"

**Template:**
```html
<h1>Welcome to CBD Wellness 24! 🌿</h1>
<p>Use code <strong>WELCOME20</strong> at checkout for 20% off your first order.</p>
<p>Minimum purchase: R200</p>
<p>Valid for 30 days.</p>
<a href="https://portal.cbdwellness24.co.za/products.html">Shop Now</a>
```
...
- [ ] MongoDB connected
- [ ] Admin login working (admin@cbdwellness24.co.za / Admin123!)
- [ ] Test user exists (user@cbdwellness24.co.za / User123!)
