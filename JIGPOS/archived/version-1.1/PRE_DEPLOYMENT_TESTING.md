...
- **Production Server**: https://portal.cbdwellness24.co.za (154.66.197.104)
...
curl -H "Origin: https://cbdwellness24.co.za" \
...
### Code Review
- [ ] All API URLs point to `https://portal.cbdwellness24.co.za/api/v1`
...
```bash
curl -I https://portal.cbdwellness24.co.za
```
...
- **Developer**: Review logs with `pm2 logs cbd-wellness-24`
- **Database**: Check with `mongosh cbdwellness24`
