...
class POSPrintingSystem {
    ...
    generateTillSlip(orderData) {
        ...
        receipt += 'CBD WELLNESS 24\n';
        receipt += `${ESC}!${String.fromCharCode(0)}`; // Normal text
        receipt += 'Natural Relief, Available Anytime\n';
        receipt += '================================\n';
        ...
        receipt += 'portal.cbdwellness24.co.za\n';
        receipt += 'hello@cbdwellness24.co.za\n';
...
<body>
    <div class="header">
        <div class="logo">CBD WELLNESS 24</div>
        <div class="tagline">Natural Relief, Available Anytime</div>
    </div>
    ...
    <div class="footer">
        <p>CBD Wellness 24 | portal.cbdwellness24.co.za | hello@cbdwellness24.co.za</p>
