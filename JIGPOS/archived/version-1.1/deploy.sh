...
# CBD Wellness 24 - One-Time Deployment Script
# SAFE: Does NOT touch existing PM2 apps, Nginx configs, or databases

echo "=== CBD Wellness 24 Deployment ==="
echo ""
...
# Seed database (creates NEW database: cbdwellness24)
...
# Start PM2 (adds NEW app: cbd-wellness-24)
...
echo "   sudo cp nginx-portal.conf /etc/nginx/sites-available/portal.cbdwellness24.co.za"
echo ""
echo "2. Enable site:"
echo "   sudo ln -sf /etc/nginx/sites-available/portal.cbdwellness24.co.za /etc/nginx/sites-enabled/"
echo ""
...
echo "   sudo certbot --nginx -d portal.cbdwellness24.co.za"
echo ""
