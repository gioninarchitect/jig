...
async function seedAllModules() {
    try {
        ...
        const modules = [
            // 1. DRIVE-THROUGH MODULE (24/7 Drive-Through)
            {
                ...
                status: 'available',
                icon: 'fa-car',
                screenshots: ['/images/modules/drive-through-customer.png', '/images/modules/drive-through-staff.png', '/images/modules/drive-through-queue.png'],
                documentation: 'https://docs.cbdwellness24.co.za/modules/drive-through',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
            ...
            // 2. AFFILIATE PROGRAM (Wellness Advocates)
            {
                ...
                documentation: 'https://docs.cbdwellness24.co.za/modules/affiliate-program',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
                metrics: { installations: 0, rating: 5.0, reviews: 0 },
            ...
            // 3. VIRAL MARKETING ENGINE
            {
                ...
                documentation: 'https://docs.cbdwellness24.co.za/modules/viral-marketing',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
                metrics: { installations: 0, rating: 5.0, reviews: 0 },
            ...
            // 4. MULTI-LOCATION POS
            {
                ...
                documentation: 'https://docs.cbdwellness24.co.za/modules/multi-location-pos',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
                metrics: { installations: 0, rating: 5.0, reviews: 0 },
            ...
            // 5. VOUCHER SYSTEM
            {
                ...
                documentation: 'https://docs.cbdwellness24.co.za/modules/voucher-system',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
                metrics: { installations: 0, rating: 5.0, reviews: 0 },
            ...
            // 6. LEAD MANAGEMENT CRM
            {
                ...
                documentation: 'https://docs.cbdwellness24.co.za/modules/lead-management',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
                metrics: { installations: 0, rating: 5.0, reviews: 0 },
            ...
            // 7. SECTION 21 COMPLIANCE SUITE
            {
                ...
                documentation: 'https://docs.cbdwellness24.co.za/modules/section21-compliance',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
                metrics: { installations: 0, rating: 5.0, reviews: 0 },
            ...
            // 8. MENU INTEGRATION (BEAN & BUD / LA BREWHA)
            {
                ...
                documentation: 'https://docs.cbdwellness24.co.za/modules/menu-integration',
                supportEmail: 'support@cbdwellness24.co.za',
                vendor: { name: 'CBD Wellness 24', website: 'https://cbdwellness24.co.za' },
                metrics: { installations: 0, rating: 5.0, reviews: 0 },
