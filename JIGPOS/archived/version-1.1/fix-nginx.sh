...
# Remove all lines containing portal.cbdwellness24.co.za
sudo sed -i '/portal\.cbdwellness24\.co\.za/d' /etc/nginx/sites-available/portal-openpharms
...
if [ $? -eq 0 ]; then
    ...
    echo "Done! Check https://portal.cbdwellness24.co.za"
else
