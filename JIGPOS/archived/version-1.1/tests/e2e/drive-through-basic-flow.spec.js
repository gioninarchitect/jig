...
test.describe('Drive-Through Basic Flow (No EFT Approval)', () => {
    ...
    test('Complete basic flow: Login → Order → Staff Queue', async ({ browser }) => {
        ...
        // STEP 1: Go directly to drive-through page (has built-in login)
        console.log('🧪 STEP 1: Load Drive-Through Page');
        ...
        console.log('\n🧪 STEP 2: Customer Login via Drive-Through Page');
        ...
        if (isLoginVisible) {
            ...
            // Fill in credentials
            await emailInput.fill('user@cbdwellness24.co.za');
