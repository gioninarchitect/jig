# UAT Test Results - CBD Wellness 24
**Date**: 2025-11-05
...
|------|-------|----------|----------------|
| Admin | admin@cbdwellness24.co.za | Admin123! | ✅ Active |
| Store Manager | manager@cbdwellness24.co.za | Manager123! | ✅ Active |
| Shop Assistant | assistant@cbdwellness24.co.za | Assistant123! | ✅ Active |
| Lifestyle Member | user@cbdwellness24.co.za | User123! | ✅ Active |
| Section 21 Patient | patient@cbdwellness24.co.za | Patient123! | ✅ Active |

---

## 1. Admin Testing (admin@cbdwellness24.co.za / Admin123!)
...
## 2. Manager Testing (manager@cbdwellness24.co.za / Manager123!)
...
## 3. Assistant Testing (assistant@cbdwellness24.co.za / Assistant123!)
...
## 5. Regular User Testing (user@cbdwellness24.co.za / User123!)
...
## 6. Patient Testing (patient@cbdwellness24.co.za / Patient123!)
