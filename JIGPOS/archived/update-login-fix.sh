...
echo "============================================"
echo ""
echo "1. Upload the updated login.html to /var/www/bmh/"
echo ""
echo "2. Test the login at https://portal.basothomedicalherbs.ls/login"
echo ""
echo "3. Use these test credentials:"
echo "   - Admin: admin@basothomedicalherbs.ls / CBDWellness2024!"
echo "   - Staff Assistant: assistant@basothomedicalherbs.ls / Assistant123!"
echo ""
echo "CHANGES MADE:"
