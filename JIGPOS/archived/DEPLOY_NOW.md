...
**Upload to**: basothomedicalherbs.ls via FTP
**Changes made**:
...
**Upload Instructions**:
```
1. Connect to basothomedicalherbs.ls FTP
...
**Deploy to**: 154.66.197.104 (portal.basothomedicalherbs.ls)
...
# Export leads backup
mongoexport --db bmh --collection leads --out leads-backup.json
```
...
1. Verify leads in MongoDB: `mongosh bmh`
