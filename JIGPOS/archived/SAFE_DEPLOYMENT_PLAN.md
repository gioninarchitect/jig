# Basotho Medical Herbs - Safe Deployment Plan
...
- **bmh**: Does NOT exist (GOOD - we'll create it)
...
**Expected Output**: You should see `bmh` in the database list
