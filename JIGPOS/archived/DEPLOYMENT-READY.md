# Basotho Medical Herbs - Production Deployment Summary
...
|------|-------|----------|----------|--------|
| Admin | admin@basothomedicalherbs.ls | Admin123! | admin.html | ✅ WORKING |
| Store Manager | manager@basothomedicalherbs.ls | Manager123! | admin.html | ✅ WORKING |
| Shop Assistant | assistant@basothomedicalherbs.ls | Assistant123! | admin.html | ✅ WORKING |
| Lifestyle Member | user@basothomedicalherbs.ls | User123! | dashboard.html | ✅ WORKING |
| Section 21 Patient | patient@basothomedicalherbs.ls | Patient123! | dashboard.html | ✅ WORKING |
...
### On Production Server (portal.basothomedicalherbs.ls)
...
# scp create-uat-users.js username@portal.basothomedicalherbs.ls:/var/www/bmh/
...
1. **Login as Assistant**:
   - Go to: https://portal.basothomedicalherbs.ls/login.html
...
# Check specific user
mongosh bmh --eval "db.users.findOne({email: 'assistant@basothomedicalherbs.ls'})"

# Reset user password
mongosh bmh --eval "
  const user = db.users.findOne({email: 'assistant@basothomedicalherbs.ls'});
...
mongosh bmh --eval "db.products.countDocuments()"

# Check inventory has stock
mongosh bmh --eval "db.products.find({'inventory.quantity': {\$gt: 0}}).count()"
