# UAT Deployment Checklist for Basotho Medical Herbs
...
**On your SSH terminal (portal.basothomedicalherbs.ls):**
...
Expected output:
```
✓ Updated admin@basothomedicalherbs.ls
✓ Updated manager@basothomedicalherbs.ls
✓ Created assistant@basothomedicalherbs.ls
✓ Updated user@basothomedicalherbs.ls
✓ Updated patient@basothomedicalherbs.ls
```
...
# Upload to server
scp uat-deployment-*.tar.gz username@portal.basothomedicalherbs.ls:/var/www/bmh/

# SSH into server
ssh username@portal.basothomedicalherbs.ls
...
**Login as**: user@basothomedicalherbs.ls / User123!
...
**https://portal.basothomedicalherbs.ls/uat-testing.html**

| Role | Email | Password | Expected Dashboard |
|------|-------|----------|-------------------|
| Admin | admin@basothomedicalherbs.ls | Admin123! | admin.html |
| Store Manager | manager@basothomedicalherbs.ls | Manager123! | admin.html (limited) |
| Shop Assistant | assistant@basothomedicalherbs.ls | Assistant123! | pos.html or admin.html POS tab |
| Lifestyle Member | user@basothomedicalherbs.ls | User123! | dashboard.html |
| Section 21 Patient | patient@basothomedicalherbs.ls | Patient123! | dashboard.html |
...
pm2 logs bmh | grep "Login attempt"

# Check MongoDB connection
mongosh bmh --eval "db.users.find({}, {email: 1, role: 1}).pretty()"
...
- CORS configured for production domain: portal.basothomedicalherbs.ls
...
- **Admin Panel**: https://portal.basothomedicalherbs.ls/admin
- **Dashboard**: https://portal.basothomedicalherbs.ls/dashboard
