...
echo "MongoDB Database Import for Basotho Medical Herbs"
echo "============================================"
echo ""

DB_NAME="bmh"
DUMP_FILE="cbd-db-backup-20251107-1430.tar.gz"
DEPLOY_DIR="/var/www/bmh"
...
mongorestore --db=$DB_NAME --drop cbd-db-backup-20251107-1430/bmh/
...
echo "Restart application with: pm2 restart bmh"
