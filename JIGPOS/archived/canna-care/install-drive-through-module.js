...
async function installModule() {
    try {
        ...
        const user = await User.findOne({ email: 'user@cbdwellness24.co.za' });
        if (!user) {
        ...
        if (existing) {
            ...
            console.log('Installing drive-through module...');
        ...
        console.log('✅ Drive-through module is now active for user@cbdwellness24.co.za');
        process.exit(0);
    } catch (error) {
