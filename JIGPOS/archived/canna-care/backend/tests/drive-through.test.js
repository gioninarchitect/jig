...
describe('Drive-Through Module', () => {
    ...
    beforeAll(async () => {
        ...
        await mongoose.connect('mongodb://localhost:27017/cbdwellness24_test', {
        ...
        testProduct = await Product.create({
            ...
            description: 'Test product for drive-through',
            inventory: {
                quantity: 50,
        ...
        // Create module installation for drive-through
    ...
    describe('POST /api/v1/drive-through/order', () => {
        it('should create a drive-through order with pre-payment', async () => {
            const orderData = {
                products: [
                    {
    ...
    describe('GET /api/v1/drive-through/queue', () => {
        beforeEach(async () => {
            await DriveThrough.deleteMany({});
    ...
    describe('GET /api/v1/drive-through/orders/:orderId', () => {
        let testOrder;
        ...
        it('should get order details for owner', async () => {
            const response = await request(API_URL)
                .get(`/drive-through/orders/${testOrder.orderId}`)
                .set('Authorization', `Bearer ${customerToken}`);
    ...
    describe('POST /api/v1/drive-through/complete', () => {
        let testOrder;
    ...
    describe('POST /api/v1/drive-through/cancel', () => {
        let testOrder;
