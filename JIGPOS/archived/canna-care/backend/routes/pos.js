...
router.get('/sales/today', authenticateToken, requireRole(['admin', 'staff_manager', 'staff_assistant']), async (req, res) => {
  try {
...
router.post('/payment/:saleId/approve', authenticateToken, requireRole(['admin', 'staff_manager']), async (req, res) => {
  try {
...
router.get('/payments/pending', authenticateToken, requireRole(['admin', 'staff_manager']), async (req, res) => {
  try {
    const { branchId } = req.query;
...
// Void sale
router.post('/sale/:saleId/void', authenticateToken, requireRole(['admin', 'staff_manager']), async (req, res) => {
  try {
    const { saleId } = req.params;
...
router.post('/till/open', authenticateToken, requireRole(['admin', 'staff_manager', 'staff_assistant']), async (req, res) => {
  try {
...
// Get active till session
router.get('/till/active', authenticateToken, requireRole(['admin', 'staff_manager', 'staff_assistant']), async (req, res) => {
  try {
...
router.post('/till/close', authenticateToken, requireRole(['admin', 'staff_manager', 'staff_assistant']), async (req, res) => {
  try {
...
router.post('/till/cash-in', authenticateToken, requireRole(['admin', 'staff_manager', 'staff_assistant']), async (req, res) => {
  try {
    ...
    console.error('Record cash-in error:', error);
    res.status(500).json({
      success: false,
...
router.post('/till/cash-out', authenticateToken, requireRole(['admin', 'staff_manager', 'staff_assistant']), async (req, res) => {
  try {
    const { sessionId, amount, reason } = req.body;
    ...
    console.error('Record cash-out error:', error);
    res.status(500).json({
      success: false,
...
router.get('/till/sessions/today', authenticateToken, requireRole(['admin', 'staff_manager']), async (req, res) => {
  try {
    const { branchId } = req.query;
...
router.get('/till/sessions/history', authenticateToken, requireRole(['admin', 'staff_manager']), async (req, res) => {
  try {
...
router.post('/till/session/:sessionId/approve', authenticateToken, requireRole(['admin', 'staff_manager']), async (req, res) => {
  try {
    ...
    console.error('Approve till session error:', error);
    res.status(500).json({
      success: false,
    ...
    if (items && items.length > 0) {
      for (const item of items) {
        try {
          ...
          console.error('Inventory restore error:', error.message);
        }
      }
    }
