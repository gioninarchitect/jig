/**
 * Till Management System for CBD Wellness 24 Admin POS
...
function showAdminToast(title, message, type = 'info') {
    // Reuse existing toast function if available, otherwise create simple alert
