// CBD Wellness 24 - Authentication E2E Tests
...
test.describe('CBD Wellness 24 - Authentication Tests', () => {
  ...
  test('Invalid Login - Wrong Password', async ({ page }) => {
    ...
    await page.locator('#loginForm input[type="email"]').fill('admin@cbdwellness24.co.za');
