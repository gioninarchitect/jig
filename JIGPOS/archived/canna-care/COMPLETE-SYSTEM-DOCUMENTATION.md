# CBD Wellness 24 - Complete System Documentation
...
## 🗄️ DATABASE SCHEMA (MongoDB: `cbdwellness24`)
...
# JWT
JWT_SECRET=cbdwellness24_secret_key_change_in_production
...
SMTP_FROM=hello@cbdwellness24.co.za
...
# 2. Upload to server
scp cbd-deploy-*.tar.gz user@portal.cbdwellness24.co.za:/var/www/cbd-wellness-24/
...
- Admin: https://portal.cbdwellness24.co.za/admin
...
4. **Database**: `cbdwellness24` (separate from `loosedraw`)
5. **Auth Storage**:
...
# Login: admin@cbdwellness24.co.za / Admin123!
```
...
**Contact**: hello@cbdwellness24.co.za
