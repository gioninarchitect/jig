...
## Overview
The 24/7 Drive-Through system is fully integrated with the existing Basotho Medical Herbs infrastructure. It's essentially **another sales channel** using the same product database, ordering system, and inventory management.
