# Basotho Medical Herbs - Testing Guide
...
**Login**: user@basothomedicalherbs.ls / User123!
...
**Login**: patient@basothomedicalherbs.ls / Patient123!
...
**Login**: pending@basothomedicalherbs.ls / Pending123!
...
**Login**: manager@basothomedicalherbs.ls / Manager123!
...
**Login**: assistant@basothomedicalherbs.ls / Assistant123!
...
curl -X POST http://localhost:3001/api/v1/auth/login \
  ...
  -d '{"email":"user@basothomedicalherbs.ls","password":"User123!"}'
```
...
curl -X POST http://localhost:3001/api/v1/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"patient@basothomedicalherbs.ls","password":"Patient123!"}'
```
...
```bash
mongosh bmh
db.users.findOne({email: "user@basothomedicalherbs.ls"})
```
