...
**Project Name**: Basotho Medical Herbs - 24/7 Medical Cannabis Drive-Through Module
**Version**: 1.0.0
...
A modular add-on for Basotho Medical Herbs enabling 24/7 drive-through service for medical cannabis and wellness products. This module integrates with the existing core platform (POS, inventory, orders, Section 21 compliance) while operating as an independent plugin that can be enabled/disabled.

## Business Context

Basotho Medical Herbs operates in the regulated medical cannabis market in South Africa, requiring strict Section 21 compliance for prescription products.
...
6. **MongoDB** (`bmh` database) - Data persistence
...
**Database**: MongoDB (existing `bmh` database)
