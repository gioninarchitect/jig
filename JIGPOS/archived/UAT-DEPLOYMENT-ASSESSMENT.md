...
**Portal**: https://portal.basothomedicalherbs.ls
...
1. **Admin Login** ✅
   ...
   - Credentials: admin@basothomedicalherbs.ls / Admin123!
...
5. **Manager Login** ✅
   - Login works with manager@basothomedicalherbs.ls / Manager123!
   - Redirects to admin panel (correct)
   - Can access inventory management

6. **Assistant Login** ✅
   - Login works with assistant@basothomedicalherbs.ls / Assistant123!
   - Redirects to admin panel
   - POS tab visible
   - Can add products to POS cart

7. **User Login** ✅
   - Login works with user@basothomedicalherbs.ls / User123!
   - Redirects correctly to dashboard.html
   - Dashboard loads successfully

8. **Patient Login** ✅
   - Login works with patient@basothomedicalherbs.ls / Patient123!
...
1. **admin@basothomedicalherbs.ls** / Admin123!
   - Role: Admin
   - Status: ✅ WORKING

2. **manager@basothomedicalherbs.ls** / Manager123!
   - Role: Staff Manager
   - Status: ✅ WORKING

3. **assistant@basothomedicalherbs.ls** / Assistant123!
   - Role: Staff Assistant
   - Status: ✅ WORKING

4. **user@basothomedicalherbs.ls** / User123!
   - Role: User (Lifestyle Member)
   - Status: ✅ WORKING

5. **patient@basothomedicalherbs.ls** / Patient123!
...
scp create-uat-users.js username@portal.basothomedicalherbs.ls:/var/www/bmh-24/
...
```
1. Login as assistant@basothomedicalherbs.ls
...
mongosh bmh --eval "db.products.count()"
```
...
tar -czf bmh-uat-$(date +%Y%m%d-%H%M).tar.gz \
...
# Upload to server
scp bmh-uat-*.tar.gz username@portal.basothomedicalherbs.ls:/var/www/bmh-24/
```
...
**UAT Testing Portal**: https://portal.basothomedicalherbs.ls
**UAT Testing Guide**: https://portal.basothomedicalherbs.ls/uat-testing.html
