 ...
 * OpenAPI 3.0 specification for Basotho Medical Herbs REST API
 */
...
const swaggerOptions = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Basotho Medical Herbs API',
      version: '1.0.0',
      description: 'Cannabis Wellness & Accessories E-commerce Platform REST API',
      contact: {
        name: 'Basotho Medical Herbs',
        email: 'hello@basothomedicalherbs.ls',
        url: 'https://basothomedicalherbs.ls'
      },
      license: {
        name: 'Proprietary',
        url: 'https://basothomedicalherbs.ls/license'
      }
    },
    servers: [
      {
