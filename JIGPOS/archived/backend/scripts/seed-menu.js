// Seed Menu Items for Thaba Café & Morija Roastery
...
async function seedMenu() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/bmh', {
    ...
    console.log('\n📊 Menu Summary:');
    console.log(`   Thaba Café items: ${laBrewhaCount}`);
    console.log(`   Morija Roastery items: ${beanBudCount}`);
