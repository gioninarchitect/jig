// OTP Authentication Routes - PIN-less email OTP authentication
...
router.post('/verify', async (req, res) => {
  try {
    ...
    // Verify OTP
    const verification = await OTPCode.verifyOTP(email.toLowerCase(), code);
 ...
 * POST /api/v1/auth/otp/logout-all
 */
 ...
 * DELETE /api/v1/auth/otp/sessions/:sessionId
 */
