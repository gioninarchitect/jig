...
function getJwtSecret() {
  ...
  if (process.env.NODE_ENV === 'development') {
    logger.warn('[Config] Using development JWT_SECRET. SET JWT_SECRET in .env for production!');
...
module.exports = {
  ...
  email: {
    ...
    from: process.env.SMTP_FROM_EMAIL || process.env.EMAIL_FROM || 'hello@basothomedicalherbs.ls'
  },
