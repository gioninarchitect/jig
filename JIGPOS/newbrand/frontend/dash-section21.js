...
function openSection21Modal() {
    showConfirmModal(
        ...
        'Section 21 verification is required to access medical cannabis products. Our third-party verification portal is being integrated. In the meantime, please email hello@jig.cleva-ai.co.za with your Section 21 authorisation letter for manual verification.',
...
function loadSection21Portal() {
    if (!SECTION21_CONFIG.isConfigured) {
        ...
        showConfirmModal(
            ...
            'The Section 21 Verification Portal requires integration with a licensed medical cannabis provider. This integration is pending final configuration. In the meantime, please email hello@jig.cleva-ai.co.za for manual verification.',
            'fa-clock',
            function() {},
            'OK',
            null  // No cancel button
