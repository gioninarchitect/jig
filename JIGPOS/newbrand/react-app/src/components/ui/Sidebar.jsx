  ...
  return (
    <>
      ...
      <div
        onClick={onClose}
        className={`
          fixed inset-0 bg-origin-slate/70 z-[2000] transition-opacity duration-300
      ...
      <aside
        className={`
          fixed top-0 left-0 w-[280px] h-screen bg-origin-slate
          border-r-[3px] border-or-gold z-[2500] flex flex-col
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? 'bg-or-gold/15 border-l-or-gold font-bold'
                      : 'border-l-transparent hover:bg-or-gold/10 hover:border-l-or-gold'
                  }
                `}
              >
