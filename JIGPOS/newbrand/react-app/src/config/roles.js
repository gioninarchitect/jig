...
export const ROLE_HIERARCHY = {
  ...
  pharmacy_admin:    { level: 70,  label: 'Pharmacy Admin' },
  responsible_pharmacist: { level: 65, label: 'Responsible Pharmacist' },
  pharmacist:        { level: 55,  label: 'Pharmacist' },
  branch_manager:    { level: 60,  label: 'Branch Manager' },
  inventory_manager: { level: 50,  label: 'Inventory Manager' },
  pharmacy_assistant:{ level: 25,  label: 'Pharmacy Assistant' },
...
export const ROLE_PERMISSIONS = {
  ...
  pharmacy_admin:    ['manage_pharmacy_queue', 'manage_pharmacy_staff', 'view_pharmacy_ledger', 'manage_orders'],
  responsible_pharmacist: ['dispense_signoff', 'manage_pharmacy_queue', 'view_pharmacy_ledger', 'manage_orders'],
  pharmacist:        ['pharmacy_arrival_scan', 'otp_collection', 'manage_orders'],
  pharmacy_assistant:['pharmacy_pickup_queue'],
...
export const ROLE_REDIRECTS = {
  ...
  responsible_pharmacist: '/admin',
  pharmacist:        '/admin',
  pharmacy_assistant:'/admin',
