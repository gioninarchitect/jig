...
// Add product to session + search
router.post('/session/:sessionId/add-item', authenticateToken, controller.addItemToSession);
router.get('/search-products', authenticateToken, controller.searchProducts);
