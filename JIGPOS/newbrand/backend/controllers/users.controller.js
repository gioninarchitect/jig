// Users Controller — Business logic extracted from routes/users.js
...
// GET / — list users with filtering/pagination (auth+admin)
...
// GET /:userId — single user (auth+admin)
...
// POST / — create user with bcrypt hashing (auth+admin)
...
// PUT /:userId — update user fields (auth+admin)
...
// DELETE /:userId — delete user, prevents self-delete (auth+admin)
...
// POST /:userId/reset-password — reset password (auth+admin)
