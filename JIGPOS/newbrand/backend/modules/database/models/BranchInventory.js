...
// Method to add stock back (for refunds)
branchInventorySchema.methods.addStock = function(quantity, reason, userId) {
  return this.recordMovement('return', quantity, reason, `Stock returned`, userId);
};
