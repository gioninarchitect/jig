...
affiliateSchema.index({ email: 1 }); // For login queries
affiliateSchema.index({ username: 1 }); // For login queries
affiliateSchema.index({ affiliateCode: 1 }); // For tracking clicks/conversions (most frequent)
affiliateSchema.index({ status: 1 }); // For filtering by status
affiliateSchema.index({ affiliateType: 1 }); // For filtering by type
affiliateSchema.index({ status: 1, affiliateType: 1 }); // Compound index for admin queries
affiliateSchema.index({ createdAt: -1 }); // For sorting by registration date
affiliateSchema.index({ 'metrics.totalSales': -1 }); // For leaderboard queries
