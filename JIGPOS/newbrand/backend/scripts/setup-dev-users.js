...
const users = [
  ...
  // ========================================
  // ORMONDE COLLECTION POINT STAFF
  // ========================================
  {
    email: 'ormonde.manager@dabudchef.co.za',
  ...
  {
    email: 'ormonde.assistant1@dabudchef.co.za',
  ...
  {
    email: 'ormonde.assistant2@dabudchef.co.za',
...
async function setupDevUsers() {
  try {
    ...
    console.log('  ORMONDE:');
    console.log('    - ormonde.manager@dabudchef.co.za (Manager)');
    console.log('    - ormonde.assistant1@dabudchef.co.za (Assistant)');
    console.log('    - ormonde.assistant2@dabudchef.co.za (Assistant)');
    console.log('\n  HQ:');
    console.log('    - admin@dabudchef.co.za (Admin)');
