        ...
        const modules = [
            {
                ...
                description: 'Enable 24/7 retail-store pickup for medical cannabis and wellness products with GPS tracking, queue management, and Section 21 compliance.',
                category: 'operations',
                version: '1.0.0',
                pricing: {
                    type: 'tiered',
                ...
                requirements: {
                    ...
                    requiredPermissions: ['admin', 'branch_manager']
                },
                status: 'coming-soon',
                icon: 'fa-car',
